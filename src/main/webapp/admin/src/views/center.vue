    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.dianziyouxiang"
              placeholder="电子邮箱"
              clearable
            ></el-input>
          </el-form-item>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shenfenzhenghao"
              placeholder="身份证号"
              clearable
            ></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if (
        "yonghu" == this.flag &&
        this.ruleForm.dianziyouxiang &&
        !isEmail(this.ruleForm.dianziyouxiang)
      ) {
      ...
      if (
        "yonghu" == this.flag &&
        this.ruleForm.shenfenzhenghao &&
        !checkIdCard(this.ruleForm.shenfenzhenghao)
      ) {
