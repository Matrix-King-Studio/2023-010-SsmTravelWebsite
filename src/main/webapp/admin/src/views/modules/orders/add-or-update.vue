    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.discounttotal"
              placeholder="折扣总价格"
              clearable
              :readonly="ro.discounttotal"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item class="input" label="支付类型" prop="type">
              <el-input
                v-model="ruleForm.type - 0 == 1 ? '现金' : '积分'"
                placeholder="支付类型"
                readonly
              ></el-input>
            </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        type: [{ validator: validateIntNumber, trigger: "blur" }],
        status: [],
        address: [],
      },
    };
