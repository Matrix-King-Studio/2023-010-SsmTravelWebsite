    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.gonglvebiaoti"
              placeholder="攻略标题"
              clearable
              :readonly="ro.gonglvebiaoti"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-select
              @change="jingdianmingchengChange"
              v-model="ruleForm.jingdianmingcheng"
              placeholder="请选择景点名称"
            >
              <el-option
          ...
          <div v-else>
            <el-form-item
              class="input"
              v-if="ruleForm.jingdianmingcheng"
              label="景点名称"
              prop="jingdianmingcheng"
            >
              <el-input
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.jingdianleixing"
              placeholder="景点类型"
              clearable
              :readonly="ro.jingdianleixing"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.jingdiandengji"
              placeholder="景点等级"
              clearable
              :readonly="ro.jingdiandengji"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.chuyoujijie"
              placeholder="出游季节"
              clearable
              :readonly="ro.chuyoujijie"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.chufachengshi"
              placeholder="出发城市"
              clearable
              :readonly="ro.chufachengshi"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-select
              v-model="ruleForm.chuxianfangshi"
              placeholder="请选择出现方式"
            >
              <el-option
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.xingchengtianshu"
              placeholder="行程天数"
              clearable
              :readonly="ro.xingchengtianshu"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item
        ...
        <el-col :span="24">
          <el-form-item
            class="upload"
            v-if="type != 'info' && !ro.gonglvefengmian"
            label="攻略封面"
          ...
          >
            <file-upload
              ...
              :multiple="true"
              :fileUrls="
                ruleForm.gonglvefengmian ? ruleForm.gonglvefengmian : ''
              "
          ...
          <div v-else>
            ...
            >
              <img
                ...
                v-bind:key="index"
                v-for="(item, index) in ruleForm.gonglvefengmian.split(',')"
                :src="item"
                width="100"
                height="100"
              />
      ...
      <el-row>
        <el-col :span="24">
          ...
          <div v-else>
            <el-form-item
              v-if="ruleForm.xiangqingneirong"
              label="详情内容"
              prop="xiangqingneirong"
            >
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        ...
        chufachengshi: [],
        chuxianfangshi: [],
        xingchengtianshu: [{ validator: validateIntNumber, trigger: "blur" }],
        gonglvefengmian: [],
        xingchengluxian: [],
        xiangqingneirong: [],
  ...
  methods: {
    ...
    jingdianmingchengChange() {
      this.$http({
        url:
          `follow/jingdianjieshao/jingdianmingcheng?columnValue=` +
          this.ruleForm.jingdianmingcheng,
        method: "get",
      }).then(({ data }) => {
        if (data && data.code === 0) {
